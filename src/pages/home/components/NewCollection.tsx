      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-5 mt-10">
          <div className="h-[340px] md:h-[700px] relative row-span-2">
            <img loading='lazy' src={collection1} className="w-full h-full object-cover aspect-video md:aspect-auto rounded-3xl" alt="collection-image" />
          ...
          <div className="h-[340px] relative">
            <img loading='lazy' src={collection2} className="w-full h-full object-cover aspect-video md:aspect-auto rounded-3xl" alt="collection-image" />
            <div className="absolute left-1/2 top-1/2 -translate-x-[50%] -translate-y-[50%] text-white">
          ...
          <div className="h-[340px] relative">
            <img loading='lazy' src={collection3} className="w-full h-full object-cover aspect-video md:aspect-auto rounded-3xl" alt="collection-image" />
            <div className="absolute left-1/2 top-1/2 -translate-x-[50%] -translate-y-[50%] text-white">
