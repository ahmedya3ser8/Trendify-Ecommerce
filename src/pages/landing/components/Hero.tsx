    ...
    <section className='hero py-10 md:py-16'>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-[65%_30%] gap-12 items-center px-5 md:px-0">
          ...
          <div className="col relative">
            <img loading='lazy' src={heroImg} className="w-full h-[350px] md:h-full rounded-[90px_40px]" alt="landing-image" />
            <img loading='lazy' src={shape} className="absolute w-[80px] top-0 left-1/2 -translate-x-[50%] -translate-y-[50%]" alt="shape" />
          </div>
        </div>
      </div>
    </section>
